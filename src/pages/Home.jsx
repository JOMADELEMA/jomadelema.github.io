...
const Home = () => {
  ...
  return (
    <>
      <div
        className="font-semibold text-black dark:text-white h-full bg-gray-200 dark:bg-gray-600 flex-auto overflow-auto"
        id="home-section"
      >
        <div className="h-full w-full bg-black">
          ...
          >
            <div
              className="w-full h-full laptop:h-1/3 px-10 bg-f-hover1 dark:bg-fdark-hover1 dark:border-b laptop:dark:border-r laptop:dark:border-t shadow-md flex flex-col justify-center items-center 
            laptop:w-1/2 laptop:rounded-br-md laptop:rounded-tr-md border-neutral-600"
            >

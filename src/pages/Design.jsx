...
const Design = () => {
  return (
    <>
      ...
      >
        {designs.map((index) => (
          <div className="border border-neutral-800 hover:border-neutral-700 hover:bg-neutral-800 hover:shadow-sm hover:shadow-neutral-700 p-5 dark:bg-neutral-800 overflow-clip rounded-lg">
            <a
              href={index.social}
              target="_blank"
              rel="noreferrer"

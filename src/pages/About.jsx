...
const About = () => {
  ...
  const card = "w-5/6 h-48 text-sm text-left dark:border shadow rounded-md my-2 p-2 hover:shadow-md hover:bg-gray-100 dark:hover:bg-gray-900 hover:duration-500";
  const cardTitle ="font-semibold text-lg underline text-center mb-2";
  ...
  return (
    <>
        ...
        <div className="w-full h-full text-black dark:text-white flex flex-col justify-center items-center">
          ...
          <div className="font-semibold text-lg tablet:text-2xl flex">
            <span>Level:</span>
            <div className="ml-2">{aboutMeData.currentLevel}</div>
          </div>

          <div className="w-full flex justify-center">
            <div className="w-5/6 text-sm tablet:text-lg py-5 tablet:py-2">
